  ...
  return(
    <div id='contact' className='flex flex-col gap-5 justify-evenly items-center h-screen font-[consolas] text-4xl'>
      ...
      <div className="flex flex-col gap-5">
        <a href="mailto:hamzaaz00721@gmail.com" className={`underline ${roboto.className} my-2 text-center`}>hamzaaz00721@gmail.com</a>
      <div className='flex flex-row gap-5 justify-between items-center'>
        <a href="https://www.upwork.com/freelancers/~01f3b3b3b3b3b3b3b3" target="_blank" rel="noopener noreferrer"
